...
import com.microboat.common.logger.ILogger
import com.microboat.common.logger.ILoggerProvider
...
private val immutableMapClasses: Set<KClass<out Map<*, *>>> = setOf(
    emptyMap<Any, Any>()::class,
    mapOf<Any, Any>(1 to 1)::class
)
...
fun Any.isMutableMap(): Boolean {
    ...
    return this::class !in immutableMapClasses
}
